<template>
  <!-- 상품컴포넌트 시작 -->
    <li data-v-7f6b5e24="" class="col-3 withProduct hasDelete"><div data-v-7f6b5e24="" class="cartProduct order-1 hasCheckbox"><input data-v-7f6b5e24="" id="cartProduct1_1" type="checkbox" name="cartProduct1cs224302745" area-title="아이르 선택" class="cur_hand"><label data-v-7f6b5e24="" for="cartProduct1_1" class="blind">울트라 훼이셜 크림 125ml</label>
    <div data-v-7f6b5e24="" class="productItem">
        <div data-v-7f6b5e24="" class="productThumb">
            <a data-v-7f6b5e24="" href="//www.lotteon.com/p/product/LE1204369004?sitmNo=LE1204369004_1223470908&amp;dp_infw_cd=SCT&amp;entryPoint=mysel&amp;mall_no=1">
            <img data-v-7f6b5e24="" :src="`https://contents.lotteon.com/itemimage/_v090000/LE/12/04/36/90/04/_1/22/34/70/90/8/${cartItemInfo.product[0].sitmNo}_M.jpg/dims/resizemc/100x100`" alt="울트라 훼이셜 크림 125ml"></a><!----></div><div data-v-7f6b5e24="" class="productData"><p data-v-7f6b5e24="" class="productFlag"></p><a data-v-7f6b5e24="" href="//www.lotteon.com/p/product/LE1204369004?sitmNo=LE1204369004_1223470908&amp;dp_infw_cd=SCT&amp;entryPoint=mysel&amp;mall_no=1">
    <p data-v-7f6b5e24="" class="productTitle">
        <strong style="-webkit-text-stroke: medium;">{{cartItemInfo.product[0].brdNm}}</strong>
                {{cartItemInfo.product[0].spdNm }} {{cartItemInfo.cartSn}}
